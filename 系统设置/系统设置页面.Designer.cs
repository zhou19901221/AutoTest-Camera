namespace 自动测试
{
    partial class 系统设置页面
    {
        ...
        private void InitializeComponent()
        {
            ...
            电压模块控件1.Size = new Size(1782, 923);
            电压模块控件1.TabIndex = 0;
            // 
            // MESS设置页
            // 
            ...
            MESS设置页.Size = new Size(1782, 923);
            MESS设置页.TabIndex = 9;
            MESS设置页.Text = "MESS设置";
            ...
            保存按钮.Location = new Point(1560, 959);
            保存按钮.Name = "保存按钮";
            ...
            取消按钮.Location = new Point(1678, 959);
            取消按钮.Name = "取消按钮";
